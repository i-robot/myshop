   ...
   <table cellspacing="1" cellpadding="3" width="100%" class="form-table">
	...
	<tr>
		...
		<td><input type="radio" name="adv.isclose" value="0"
			<c:if test="${adv.isclose == 0 }">checked</c:if> /> 开启&nbsp;&nbsp; <input type="radio"
			name="adv.isclose" value="1" <c:if test="${adv.isclose == 1 }">checked</c:if>/> 关闭&nbsp;&nbsp;<span class="help_icon" helpid="ad_isclose"></span></td>
	</tr>
