...
首重费用 <input type="text"   name="firstprice" style="width: 30px;" disabled="true" dataType="float" isrequired="true"/>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
续重费用 <input type="text"   name="continueprice" style="width: 30px;" disabled="true" dataType="float" isrequired="true"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
