 ...
 <form class="validate" method="post" action="member!saveAddLv.do" name="theForm" id="theForm"  >
   <table cellspacing="1" cellpadding="3" width="100%" class="form-table">
     <tr>
       ...
       <td width="27%"><input type="text" name="lv.name" id="name" maxlength="60" value="" dataType="string" isrequired="true"/>       </td>
       <td width="58%" align="left"><div id="nameTip" style="width:80px;"></div></td>
     </tr>
     <tr>
       <th><label class="text">所需积分</label></th>
       <td width="27%"><input type="text" name="lv.point" id="name"  style="width:80px" value="0" dataType="int" isrequired="true"/>       </td>
       <td width="58%" align="left"><div id="nameTip" style="width:80px;"></div></td>
     </tr>
     <tr>
