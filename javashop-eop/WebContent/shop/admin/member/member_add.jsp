...
<table cellspacing="1" cellpadding="3" width="100%"  class="form-table">
	<tr>
		<td class="label" style="text-align:right;width:250px"><label class="text">用户名：</label></td>
		<td valign="middle">&nbsp;<input type="text" name="member.uname"
			id="uname" value="" dataType="string" isrequired="true" /></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td valign="middle">&nbsp; <input isrequired="true" dataType="date" name="birthday" id="birthday" value="1980-01-01" readonly="true"  class="dateinput" /> </td>
	</tr>
	<tr>
		<td class="label" style="text-align:right"><label class="text">Email：</label></td>
		<td valign="middle">&nbsp; <input type="text" name="member.email"
			value="" id="email" dataType="email"  isrequired="true"/></td>
	</tr>
	<tr>
