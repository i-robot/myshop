...
<table cellspacing="1" cellpadding="3" width="100%" class="form-table">
	...
	<tr>
		...
		<td valign="middle">&nbsp; <input type="text" name="birthday" value="<html:dateformat pattern="yyyy-MM-dd" time="${member.birthday }"></html:dateformat>" maxlength="60" dataType="date" isrequired="true" class="dateinput"/></td>
	</tr>
	<tr>
