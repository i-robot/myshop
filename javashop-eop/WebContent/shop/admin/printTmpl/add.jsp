...
<script type="text/javascript">
	...
	swfobject.embedSWF("js/OrderDesign.swf", "swf", "100%", "100%",
	...
	<div style="height:67px;width:1000px;border:1px solid #ff0000;">
		...
		<div class="title">
			...
			<select onchange="createItem(this);">
				...
				<option value="收货人-省|ship_province">收货人-省</option>
				<option value="收货人-市|ship_city">收货人-市</option>
				<option value="收货人-区|ship_region">收货人-区</option>				
				...
				<option value="发货人-省|dly_province">发货人-省</option>
				<option value="发货人-市|dly_city">发货人-市</option>
				<option value="发货人-区|dly_region">发货人-区</option>				
