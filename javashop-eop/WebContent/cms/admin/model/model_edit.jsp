	 ...
	 <input type="hidden" name="dataModel.model_id" value="${dataModel.model_id }" id="modelid"/>
	   <table cellspacing="1" cellpadding="3" width="100%" class="form-table">
	     <tr>
	       ...
	       <td><input type="text" name="dataModel.china_name" maxlength="60" value="${dataModel.china_name }"  dataType="string" isrequired="true" /></td>
	      </tr>
	     <tr>
	       <th><label class="text">表名：</label></th>
	       <td><input type="text" name="dataModel.english_name"  maxlength="60" size="40" value="${ dataModel.english_name}"  isrequired="true"  dataType="string"/></td>
	      </tr>
	     <tr>
