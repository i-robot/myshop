	 ...
	 <form method="post" action="model!saveAdd.do" class="validate" name="theForm" id="theForm" >
	   <table cellspacing="1" cellpadding="3" width="100%" class="form-table">
	     <tr>
	       ...
	       <td><input type="text" name="dataModel.china_name" maxlength="60" value=""  dataType="string" isrequired="true" /></td>
	      </tr>
	     <tr>
	       <th><label class="text">表名：</label></th>
	       <td><input type="text" name="dataModel.english_name"  maxlength="60" size="40" value=""  isrequired="true"  dataType="string"/></td>
	      </tr>
	     <tr>
