	 ...
	 <form method="post"   id="fieldForm" >
	   ...
	   <table cellspacing="1" cellpadding="3" width="100%" class="form-table">
	     <tr>
	       ...
	       <td><input type="text" name="dataField.china_name" value="${dataField.china_name }"  dataType="string" isrequired="true" /></td>
	      </tr>
	     <tr>
	       <th><label class="text">字段名：</label></th>
	       <td><input type="text" name="dataField.english_name"   value="${dataField.english_name }"  isrequired="true"  dataType="string"/></td>
	      </tr>
	     <tr>
	     ...
	     <tr>
	       ...
	       <td><input type="text" name="dataField.data_size"  style="width:50px"  value="${ dataField.data_size}"  isrequired="true"  dataType="string"/></td>
	      </tr>
 --> 
	     <tr id="saveValueTr">
	     ...
	     <tr>
	       ...
	       <td><input type="text" name="dataField.taxis" style="width:50px"  value="${dataField.taxis }"  isrequired="true"  dataType="int"/></td>
	      </tr>	      
	     <tr>
